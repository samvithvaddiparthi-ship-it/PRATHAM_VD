const strings = {
  en: {
    ...
    documents_desc: 'Take a photo or upload your prescription, lab reports, or discharge summary',
    documents_passthrough_note: 'Your uploads go straight to the doctor — nothing is scanned on screen.',
  ...
  hi: {
    ...
    documents_desc: 'अपने प्रिस्क्रिप्शन, लैब रिपोर्ट या डिस्चार्ज समरी की फोटो लें या अपलोड करें',
    documents_passthrough_note: 'आपके अपलोड सीधे डॉक्टर को दिखाए जाएँगे — स्क्रीन पर कुछ स्कैन नहीं होगा।',
    uploaded_label: 'अपलोड हो गया',
  ...
  te: {
    ...
    documents_desc: 'మీ ప్రిస్క్రిప్షన్, ల్యాబ్ రిపోర్ట్‌ల ఫోటో తీయండి లేదా అప్‌లోడ్ చేయండి',
    documents_passthrough_note: 'మీ అప్‌లోడ్‌లు నేరుగా డాక్టర్‌కు చూపబడతాయి — స్క్రీన్‌పై ఏమీ స్కాన్ కాదు.',
    uploaded_label: 'అప్‌లోడ్ అయింది',
